package helper.phone.toro.com.imageselector.model;
...
import helper.phone.toro.com.imageselector.utils.StringUtils;
...
public class ImageModel {
    ...
    private static ArrayList<Folder> splitFolder(Context context,ArrayList<Image> images) {
        ...
        folders.add(new Folder(context.getString(R.string.all_picture), images));
