        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.ChangeColorIconView_color:
                    mSelectedColor = a.getColor(attr, getResources().getColor(R.color.main_tab_selected_color));
                    break;
                case R.styleable.ChangeColorIconView_normalColor:
                    mNormalColor = a.getColor(attr, getResources().getColor(R.color.main_tab_normal_color));
                    break;
