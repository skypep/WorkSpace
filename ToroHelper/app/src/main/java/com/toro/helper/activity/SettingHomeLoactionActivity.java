...
import com.toro.helper.fragment.helper.SearchResultAdapter;
 ...
 * on 2018/11/3.
 **/
public class SettingHomeLoactionActivity extends ToroActivity implements LocationSource,
    ...
    private String selectedPoiString;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.setting_home_location_activity);
        ...
        mainActionBar.updateView(getString(R.string.setting_home_location), R.mipmap.action_back_icon, 0, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
        }, null);
        mainActionBar.addRightText(getString(R.string.save), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                save();
            }
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(SettingHomeLoactionActivity.this);
    ...
    private void save() {
        LatLng latLng = locationMarker.getPosition();
        if(latLng == null) {
            return;
        }
        LocationInfo info = new LocationInfo();
        info.setPoiTitle(selectedPoiString);
        info.setLatLng(latLng);
        ToroDataModle.getInstance().getLocalData().setHomeLocation(info);
        if(ToroDataModle.getInstance().getLocalData().getSafeguardRadius() == 0) {
            finish();
            startActivity(SafeguardSettingActivity.createIntent(this));
        } else {
            finish();
        }
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(SettingHomeLoactionActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        selectedPoiString = "";
                        Toast.makeText(SettingHomeLoactionActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                selectedPoiString = "";
    ...
    private void updateListview(List<PoiItem> poiItems) {
        ...
        selectedPoiString = firstItem.getTitle();
    ...
    private void addMarkerInScreenCenter(LatLng locationLatLng) {
        ...
        locationMarker = aMap.addMarker(new MarkerOptions()
                .anchor(0.5f,0.5f)
                .icon(BitmapDescriptorFactory.fromResource(R.mipmap.map_mark_icon)));
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(SettingHomeLoactionActivity.this, "erroCode " + rCode , Toast.LENGTH_SHORT).show();
            }
        }
    };
