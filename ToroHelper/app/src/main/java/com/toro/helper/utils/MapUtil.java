...
public class MapUtil {
    ...
    public static String getGdMapAppName(Context context) {
        return getAppNameByPackageName(context,PN_GAODE_MAP);
    }

    public static String getBaiduMapName(Context context){
        return getAppNameByPackageName(context,PN_BAIDU_MAP);
    }

    public static String getQQMapName(Context context){
        return getAppNameByPackageName(context,PN_TENCENT_MAP);
    }

    public static Drawable getGdMapIcon(Context context) {
        return getIconByPackageName(context,PN_GAODE_MAP);
    }

    public static Drawable getBaiduMapIcon(Context context){
        return getIconByPackageName(context,PN_BAIDU_MAP);
    }

    public static Drawable getQQMapIcon(Context context){
        return getIconByPackageName(context,PN_TENCENT_MAP);
    }

    private static Drawable getIconByPackageName(Context context,String packageName) {
        try{
