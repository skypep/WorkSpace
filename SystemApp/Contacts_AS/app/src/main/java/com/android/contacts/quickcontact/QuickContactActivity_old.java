...
//
//        // liujia fixed
//        final Toolbar toolbar = (Toolbar) findViewById(R.id.toro_toolbar);
//        View toroView = getLayoutInflater().inflate(R.layout.toro_quick_contact_action_bar, null);
//        toroBar = toroView.findViewById(R.id.toro_action_view_container);
//        toolbar.addView(toroView);
...
//        toroBar.setLeftButton(getString(R.string.toro_back), new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if (mScroller != null) {
...
//            }
//        });
//        toroBar.setRightButton(getString(R.string.toro_more), new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                moreDialogShow();
//            }
