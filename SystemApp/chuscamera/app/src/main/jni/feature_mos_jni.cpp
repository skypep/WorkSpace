...
JNIEXPORT void JNICALL __Java_com_android_camera_Mosaic_allocateMosaicMemory(
...
JNIEXPORT void JNICALL __Java_com_android_camera_Mosaic_freeMosaicMemory(
...
JNIEXPORT jfloatArray JNICALL __Java_com_android_camera_Mosaic_setSourceImageFromGPU(
        JNIEnv* env, jobject thiz)
{
    double  t0, t1, time_c;
    t0 = now_ms();
...
JNIEXPORT jfloatArray JNICALL __Java_com_android_camera_Mosaic_setSourceImage(
...
JNIEXPORT void JNICALL __Java_com_android_camera_Mosaic_setBlendingType(
        JNIEnv* env, jobject thiz, jint type)
{
    blendingType = int(type);
}

JNIEXPORT void JNICALL __Java_com_android_camera_Mosaic_setStripType(
        JNIEnv* env, jobject thiz, jint type)
{
    stripType = int(type);
}

JNIEXPORT void JNICALL __Java_com_android_camera_Mosaic_reset(
        JNIEnv* env, jobject thiz)
{
    frame_number_HR = 0;
    frame_number_LR = 0;
...
JNIEXPORT jint JNICALL __Java_com_android_camera_Mosaic_reportProgress(
...
JNIEXPORT jint JNICALL __Java_com_android_camera_Mosaic_createMosaic(
...
JNIEXPORT jintArray JNICALL __Java_com_android_camera_Mosaic_getFinalMosaic(
        JNIEnv* env, jobject thiz)
{
    int y,x;
...
JNIEXPORT jbyteArray JNICALL __Java_com_android_camera_Mosaic_getFinalMosaicNV21(
        JNIEnv* env, jobject thiz)
{
    int y,x;
    int width;
