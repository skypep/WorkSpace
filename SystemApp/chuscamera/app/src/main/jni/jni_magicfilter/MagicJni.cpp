...
Java_com_cs_camera_magicfilter_MagicJni_jniInitMagicBeautify(JNIEnv *env, jobject instance,
                                                                jobject handler) {
...
JNIEXPORT void JNICALL
Java_com_cs_camera_magicfilter_MagicJni_jniStartWhiteSkin(JNIEnv *env, jobject instance,
                                                             jfloat whiteLevel){
    MagicBeautify::getInstance()->startWhiteSkin(whiteLevel);
}

JNIEXPORT void JNICALL
Java_com_cs_camera_magicfilter_MagicJni_jniStartSkinSmooth(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_com_cs_camera_magicfilter_MagicJni_jniUnInitMagicBeautify(JNIEnv *env, jobject instance){
    MagicBeautify::getInstance()->unInitMagicBeautify();
}

JNIEXPORT jobject JNICALL
Java_com_cs_camera_magicfilter_MagicJni_jniStoreBitmapData(JNIEnv *env, jobject instance,
                                                              jobject bitmap){
    return BitmapOperation::jniStoreBitmapData(env, instance, bitmap);
}

JNIEXPORT void JNICALL
Java_com_cs_camera_magicfilter_MagicJni_jniFreeBitmapData(JNIEnv *env, jobject instance,
                                                             jobject handle){
    BitmapOperation::jniFreeBitmapData(env, instance, handle);
}

JNIEXPORT jobject JNICALL
Java_com_cs_camera_magicfilter_MagicJni_jniGetBitmapFromStoredBitmapData(JNIEnv *env, jobject instance,
                                                                            jobject handle){
