...
public class GPUImageFilter {
    final static String TAG = "mytest.GPUImageFilter";
    ...
    protected void setInteger(final int location, final int intValue) {
        runOnDraw(new Runnable() {
            @Override
            public void run() {
                Log.v(TAG, "" + this + " setInteger location:" + location + " intValue:" + intValue);
    ...
    protected void setFloat(final int location, final float floatValue) {
        runOnDraw(new Runnable() {
            @Override
            public void run() {
                Log.v(TAG, "" + this + " setFloat location:" + location + " floatValue:" + floatValue);
    ...
    protected void setFloatVec2(final int location, final float[] arrayValue) {
        runOnDraw(new Runnable() {
            @Override
            public void run() {
                Log.v(TAG, "" + this + " setFloatVec2 location:" + location + " [0]:" + arrayValue[0]
					+ " [1]:" + arrayValue[1]);
    ...
    protected void setFloatVec3(final int location, final float[] arrayValue) {
        runOnDraw(new Runnable() {
            @Override
            public void run() {
                Log.v(TAG, "" + this + " setFloatVec3 location:" + location + " arrayValue[0]:" + arrayValue[0]);
    ...
    protected void setFloatVec4(final int location, final float[] arrayValue) {
        runOnDraw(new Runnable() {
            @Override
            public void run() {
                Log.v(TAG, "" + this + " setFloatVec4 location:" + location + " arrayValue[0]:" + arrayValue[0]);
    ...
    protected void setFloatArray(final int location, final float[] arrayValue) {
        runOnDraw(new Runnable() {
            @Override
            public void run() {
                Log.v(TAG, "" + this + " setFloatArray location:" + location + " arrayValue[0]:" + arrayValue[0]);
    ...
    protected void setPoint(final int location, final PointF point) {
        runOnDraw(new Runnable() {
            ...
            @Override
            public void run() {
                Log.v(TAG, "" + this + " setPoint location:" + location + " point:" + point.toString());
    ...
    protected void setUniformMatrix3f(final int location, final float[] matrix) {
        runOnDraw(new Runnable() {
            ...
            @Override
            public void run() {
                Log.v(TAG, "" + this + " setUniformMatrix3f location:" + location);
    ...
    protected void setUniformMatrix4f(final int location, final float[] matrix) {
        runOnDraw(new Runnable() {
            ...
            @Override
            public void run() {
                Log.v(TAG, "" + this + " setUniformMatrix4f location:" + location);
