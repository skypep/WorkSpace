...
public class MagicXproIIFilter extends GPUImageFilter{
	...
	public MagicXproIIFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicXproIIFilter.class.getSimpleName(), 1)));
	...
	public void onInitialized(){
		...
		runOnDraw(new Runnable(){
			public void run(){
				inputTextureHandles[0] = OpenGlUtils.loadTexture(MagicContext.context, "filter/xpromap.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MagicContext.context, "filter/vignettemap_new.png");
			}
		});
	}
