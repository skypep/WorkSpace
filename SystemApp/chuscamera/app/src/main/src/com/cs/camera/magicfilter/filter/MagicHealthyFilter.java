...
public class MagicHealthyFilter extends GPUImageFilter{
	...
	public MagicHealthyFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicHealthyFilter.class.getSimpleName(), 1)));
	}
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(MagicContext.context, "filter/healthy_mask_1.jpg");
		    }
	    });
	}
