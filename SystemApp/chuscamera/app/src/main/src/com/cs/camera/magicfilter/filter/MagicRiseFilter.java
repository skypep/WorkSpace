...
public class MagicRiseFilter extends GPUImageFilter{
	...
	public MagicRiseFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicRiseFilter.class.getSimpleName(), 1)));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MagicContext.context, "filter/blackboard1024.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MagicContext.context, "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(MagicContext.context, "filter/risemap.png");
		    }
	    });
	}
}