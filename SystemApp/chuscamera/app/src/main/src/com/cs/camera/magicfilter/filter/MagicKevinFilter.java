...
public class MagicKevinFilter extends GPUImageFilter{
	...
	public MagicKevinFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicKevinFilter.class.getSimpleName(), 1)));
	}
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MagicContext.context, "filter/kelvinmap.png");
		    }
	    });
	}
}
