...
public class MagicN1977Filter extends GPUImageFilter{
	...
	public MagicN1977Filter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicN1977Filter.class.getSimpleName(), 1)));
	}
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MagicContext.context, "filter/n1977map.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MagicContext.context, "filter/n1977blowout.png");
		    }
	    });
	}
}
