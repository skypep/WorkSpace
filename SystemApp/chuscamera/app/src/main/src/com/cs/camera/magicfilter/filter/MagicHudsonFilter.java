...
public class MagicHudsonFilter extends GPUImageFilter{
	...
	public MagicHudsonFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicHudsonFilter.class.getSimpleName(), 1)));
	}
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MagicContext.context, "filter/hudsonbackground.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MagicContext.context, "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(MagicContext.context, "filter/hudsonmap.png");
		    }
	    });
	}
}
