...
public class MagicTenderFilter extends GPUImageFilter{
	...
	public MagicTenderFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicTenderFilter.class.getSimpleName(), 1)));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(MagicContext.context, "filter/bluevintage_mask1.jpg");
		    }
	    });
	}
}
