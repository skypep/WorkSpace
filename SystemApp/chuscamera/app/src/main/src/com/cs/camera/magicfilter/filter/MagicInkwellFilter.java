...
public class MagicInkwellFilter extends GPUImageFilter{
	...
	public MagicInkwellFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicInkwellFilter.class.getSimpleName(), 1)));
	}
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MagicContext.context, "filter/inkwellmap.png");
		    }
	    });
	}
}
