...
public class MagicWarmFilter extends GPUImageFilter{
	...
	public MagicWarmFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicWarmFilter.class.getSimpleName(), 1)));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(MagicContext.context, "filter/warm_layer1.jpg");
		        mMaskGrey2TextureId = OpenGlUtils.loadTexture(MagicContext.context, "filter/bluevintage_mask1.jpg");
		    }
	    });
	}
}
