...
public class MagicSakuraFilter extends GPUImageFilter{
	...
	public MagicSakuraFilter(){
		//super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(R.raw.sakura));
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicSakuraFilter.class.getSimpleName(), 1)));
	}
