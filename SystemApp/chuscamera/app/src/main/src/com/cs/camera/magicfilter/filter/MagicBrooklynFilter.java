...
public class MagicBrooklynFilter extends GPUImageFilter{
	...
	public MagicBrooklynFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicBrooklynFilter.class.getSimpleName(), 1)));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MagicContext.context, "filter/brooklynCurves1.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MagicContext.context, "filter/filter_map_first.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(MagicContext.context, "filter/brooklynCurves2.png");
		    }
	    });
	}
}
