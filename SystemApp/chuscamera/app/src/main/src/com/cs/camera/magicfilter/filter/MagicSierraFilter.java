...
public class MagicSierraFilter extends GPUImageFilter{
	...
	public MagicSierraFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicSierraFilter.class.getSimpleName(), 1)));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MagicContext.context, "filter/sierravignette.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MagicContext.context, "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(MagicContext.context, "filter/sierramap.png");
		    }
	    });
	}
}