package com.cs.camera.magicfilter.widget;;
...
import com.cs.camera.magicfilter.CameraEngine;
import com.cs.camera.magicfilter.CameraInfo;
import com.cs.camera.magicfilter.video.TextureMovieEncoder;
...
public class MagicCameraView extends MagicBaseView {
	final static String TAG = "MagicCameraView";
    ...
    public MagicCameraView(Context context, AttributeSet attrs) {
        ...
        outputFile = new File(MagicContext.videoPath,MagicContext.videoName);
        recordingStatus = -1;
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        super.onSurfaceChanged(gl, width, height);	// frankie, super' onFilterChanged
        openCamera();
    }
