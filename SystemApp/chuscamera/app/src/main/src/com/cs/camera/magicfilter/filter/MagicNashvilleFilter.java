...
public class MagicNashvilleFilter extends GPUImageFilter{
	...
	public MagicNashvilleFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicNashvilleFilter.class.getSimpleName(), 1)));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MagicContext.context, "filter/nashvillemap.png");
		    }
	    });
	}
}
