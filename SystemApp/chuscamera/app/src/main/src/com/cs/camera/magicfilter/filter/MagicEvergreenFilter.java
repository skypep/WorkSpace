...
public class MagicEvergreenFilter extends GPUImageFilter{
	...
	public MagicEvergreenFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicEvergreenFilter.class.getSimpleName(), 1)));
	}
