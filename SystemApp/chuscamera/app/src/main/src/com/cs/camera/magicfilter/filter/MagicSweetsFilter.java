...
public class MagicSweetsFilter extends GPUImageFilter{
	...
	public MagicSweetsFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicSweetsFilter.class.getSimpleName(), 1)));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(MagicContext.context, "filter/rise_mask2.jpg");
		    }
	    });
	}
}
