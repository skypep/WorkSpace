...
public class MagicValenciaFilter extends GPUImageFilter{
	...
	public MagicValenciaFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicValenciaFilter.class.getSimpleName(), 1)));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(MagicContext.context, "filter/valenciamap.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(MagicContext.context, "filter/valenciagradientmap.png");
		    }
	    });
	}
}
