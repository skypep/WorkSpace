...
public class MagicSunsetFilter extends GPUImageFilter{
	...
	public MagicSunsetFilter(){
		...
		super(NO_FILTER_VERTEX_SHADER,
				OpenGlUtils.readShaderFromRawResource(FilterShaderConfig.getShaderFromClassName(MagicSunsetFilter.class.getSimpleName(), 1)));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(MagicContext.context, "filter/rise_mask1.jpg");
		        mMaskGrey2TextureId = OpenGlUtils.loadTexture(MagicContext.context, "filter/rise_mask2.jpg");
		    }
	    });
	}
}
