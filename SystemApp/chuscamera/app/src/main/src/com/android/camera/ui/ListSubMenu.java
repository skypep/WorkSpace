...
public class ListSubMenu extends ListView implements
    ...
    public int getPreCalculatedHeight() {
		...
		int setting_row_height = (int) getContext().getResources().getDimension(R.dimen.setting_row_height);
        return count * setting_row_height + (count - 1) * getDividerHeight();
    }
