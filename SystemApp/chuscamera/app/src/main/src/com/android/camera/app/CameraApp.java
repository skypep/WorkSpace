...
public class CameraApp extends Application {
	...
	public static Context sContext = null; // frankie, 2017.06.24, add
    @Override
    public void onCreate() {
        super.onCreate();
		sContext = this.getApplicationContext(); // frankie, 2017.06.24, add
		com.cs.camera.magicfilter.MagicContext.context = sContext;
