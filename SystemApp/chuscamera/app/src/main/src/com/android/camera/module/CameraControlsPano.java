...
public class CameraControlsPano extends RotatableLayout {
    ...
    private static final String TAG = "CAM_ControlsPano";
    ...
    private int mSize;
    private static final int WIDTH_GRID = 4; // 5;	// frankie, 
    private static final int HEIGHT_GRID = 8; // 7;	// frankie,
    ...
    public CameraControlsPano(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CameraControlsPano(Context context) {
        this(context, null);
    }
...
//        }
    ...
    private void setLocation(int w, int h) {
		...
		if(true) {
	        ...
	        toIndex(mPreview, w, h, rotation, 0, 7, PREVIEW_INDEX); // frankie, 
	        if(TsMakeupManager.HAS_TS_MAKEUP) {
