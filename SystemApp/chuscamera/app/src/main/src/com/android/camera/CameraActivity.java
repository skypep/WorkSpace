...
public class CameraActivity extends Activity
    ...
    public static final String ACTION_VOICE_MODULE_CAMERA_TAKE_PHOTO = "chushang.intent.action.camera.take.photo";                  // ���ģ��(����)
    public static final String ACTION_VOICE_MODULE_CAMERA_TAKE_PA_PHOTO = "chushang.intent.action.camera.take.panoramic.photo";     // ���ģ��(ȫ������)
