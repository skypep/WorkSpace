...
public class Storage {
    ...
    public static final String PHOTO_TYPE_LONGSHOT = "PHOTO_TYPE_LONGSHOT";
    public static final String PHOTO_TYPE_FRONTCAMERA = "PHOTO_TYPE_FRONTCAMERA";
    public static final String PHOTO_TYPE_PANO = "PHOTO_TYPE_PANO";

    public static final String DCIM =
            Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).toString();

    public static final String DIRECTORY = DCIM + "/Camera";
    public static final String SELF_DIRECTORY = DCIM + "/Selfphoto";
    public static final String LONGSHOT_DIRECTORY = DCIM + "/Longshot";
    public static final String PANO_DIRECTORY = DCIM + "/Pano";
    ...
    public static Uri addImage(ContentResolver resolver, String title, long date,
            ...
            int height, String mimeType,String photoType) {

        String path = generateFilepath(title, mimeType,photoType);
    ...
    public static String generateFilepath(String title, String pictureFormat) {
        return generateFilepath(title,pictureFormat,null);
    }

    public static String generateFilepath(String title, String pictureFormat ,String photoType) {
        if (pictureFormat == null || pictureFormat.equalsIgnoreCase("jpeg")) {
            ...
            } else if(photoType != null && photoType.equals(PHOTO_TYPE_PANO)){
                return  PANO_DIRECTORY + '/' + title + ".jpg";
            } else if(photoType != null && photoType.equals(PHOTO_TYPE_LONGSHOT)){
                return LONGSHOT_DIRECTORY + '/' + title + ".jpg";
            } else if(photoType != null && photoType.equals(PHOTO_TYPE_FRONTCAMERA)){
                return  SELF_DIRECTORY + '/' + title + ".jpg";
            }else {
