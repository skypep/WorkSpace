...
public class ComboPreferences implements SharedPreferences,
    ...
    public ComboPreferences(Context context) {
        ...
        mPrefGlobal = context.getSharedPreferences(getGlobalSharedPreferencesName(context), Context.MODE_PRIVATE);
        mPrefGlobal.registerOnSharedPreferenceChangeListener(this);

        synchronized (sMap) {
            sMap.put(context, this);
        }
        mListeners = new CopyOnWriteArrayList<SharedPreferences.OnSharedPreferenceChangeListener>();
    ...
    private void movePrefFrom(Map<String, ?> m, String key, SharedPreferences src) {
    ...
    private static String getLocalSharedPreferencesName(Context context, int cameraId) {
    ...
    private static boolean isGlobal(String key) {
        return key.equals(CameraSettings.KEY_CAMERA_ID)
                ...
                || key.equals(CameraSettings.KEY_CHUS_FILTER_TYPE)	// frankie, add
                ...
                || key.equals(CameraSettings.KEY_AUX_GRID);
    }
