...
public class CaptureModule implements CameraModule, PhotoController,
        ...
        public void run() {
            ...
            mActivity.runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (mLastJpegData != null) mActivity.updateThumbnail_jpeg(mLastJpegData);
                }
            });
                            ...
                            public void onImageAvailable(ImageReader reader) {
                                ...
                                if(isMpoOn()) {
                                    ...
                                    if(mLongshotActive) {
                                        ...
                                        mActivity.updateThumbnail_jpeg(bytes);
                                    }
                                    image.close();
                                }
                            }
    ...
    private void updatePictureSize() {
        ...
        Size[] prevSizes = mSettingsManager.getSupportedOutputSize(getMainCameraId(),SurfaceHolder.class);
    ...
    private class MpoSaveHandler extends Handler {
        ...
        private void saveMpoImage() {
            ...
            mActivity.updateThumbnail_jpeg(bayerBytes);
    ...
    public void onClearSightSuccess(byte[] thumbnailBytes) {
        ...
        if(thumbnailBytes != null) mActivity.updateThumbnail_jpeg(thumbnailBytes);
        mActivity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
