...
public class DisableCameraReceiver extends BroadcastReceiver {
	...
	static boolean ENABLE_CAMERA_CHECK_ON_BOOT = false;	// frankie, add
    @Override
    public void onReceive(Context context, Intent intent) {
    	if(ENABLE_CAMERA_CHECK_ON_BOOT
			&& intent != null && intent.getAction().equals(Intent.ACTION_BOOT_COMPLETED)) {
