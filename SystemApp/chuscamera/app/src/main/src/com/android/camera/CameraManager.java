...
public interface CameraManager {
    ...
    public interface TakePictureFatalErrorCallback {
        public void onTakePictureFatalError();
    }
    public interface TakePictureFatalErrorCallback_i {
    ...
    public interface CameraProxy {
        ...
        */
        ...
        // frankie, 2017.12.15, add start
        public void takePicture__i(
                Handler handler,
                CameraShutterCallback shutter,
                CameraPictureCallback raw,
                CameraPictureCallback postview,
                CameraPictureCallback jpeg, TakePictureFatalErrorCallback cb);
        // frankie, 2017.12.15, add end
