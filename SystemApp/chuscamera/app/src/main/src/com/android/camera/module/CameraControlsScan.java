...
public class CameraControlsScan extends RotatableLayout {

    private static final String TAG = "CAM_ControlsScan";
...
//    private View mIndicators;
    ...
    private int mSize;
    private static final int WIDTH_GRID = 4; // 5;
    private static final int HEIGHT_GRID = 8; // 7;
    ...
    public CameraControlsScan(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CameraControlsScan(Context context) {
        this(context, null);
    }
    ...
    /*public*/private void enableTouch(boolean enable) {
        if (enable) {
...
//        mPreview.setEnabled(enable);
    ...
    public void enableTouch_ext(boolean enable) {
        enableTouch(enable);

        ShutterButton s = (ShutterButton) mShutter;
        s.setEnabled(enable);
    }
...
//        mIndicators = findViewById(R.id.on_screen_indicators);
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        //layoutRemaingPhotos(); // frankie, rm
    }
...
////        mFrontBackSwitcher.animate().setListener(outlistener); // frankie, rm
