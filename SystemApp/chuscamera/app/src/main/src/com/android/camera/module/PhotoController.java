...
public interface PhotoController extends ShutterButton.OnShutterButtonListener {
    ...
    public void onCountDownFinished(); // CountDownView.OnCountDownFinishedListener
    ...
    public PreferenceGroup getPreferenceGroup(); // zhangjing, add

    public boolean isTakeSelfIntent();//add zj
}
