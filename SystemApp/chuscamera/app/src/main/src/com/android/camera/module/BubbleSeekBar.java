...
import static com.android.camera.module.BubbleSeekBar.TextPosition.SIDES;
import static com.android.camera.module.BubbleSeekBar.TextPosition.BOTTOM;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.seekbar_colorPrimary));
        mSecondTrackColor = a.getColor(R.styleable.BubbleSeekBar_bsb_second_track_color,
                ContextCompat.getColor(context, R.color.seekbar_colorAccent));
