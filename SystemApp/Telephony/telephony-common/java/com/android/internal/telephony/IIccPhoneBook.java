...
case TRANSACTION_updateAdnRecordsWithContentValuesInEfBySearchUsingSubId:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
...
java.lang.String _arg3;
_arg3 = data.readString();
boolean _result = this.updateAdnRecordsWithContentValuesInEfBySearchUsingSubId(_arg0, _arg1, _arg2, _arg3);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
case TRANSACTION_getAdnRecordsCapacity:
{
data.enforceInterface(DESCRIPTOR);
int[] _result = this.getAdnRecordsCapacity();
reply.writeNoException();
reply.writeIntArray(_result);
return true;
}
case TRANSACTION_getAdnRecordsCapacityForSubscriber:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
int[] _result = this.getAdnRecordsCapacityForSubscriber(_arg0);
reply.writeNoException();
reply.writeIntArray(_result);
return true;
}
...
/**
     ...
     * @return true for success
     */
@Override public boolean updateAdnRecordsWithContentValuesInEfBySearchUsingSubId(int subId, int efid, android.content.ContentValues values, java.lang.String pin2) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
_data.writeString(pin2);
mRemote.transact(Stub.TRANSACTION_updateAdnRecordsWithContentValuesInEfBySearchUsingSubId, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
@Override public int[] getAdnRecordsCapacity() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int[] _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getAdnRecordsCapacity, _data, _reply, 0);
_reply.readException();
_result = _reply.createIntArray();
}
finally {
...
@Override public int[] getAdnRecordsCapacityForSubscriber(int subId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int[] _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(subId);
mRemote.transact(Stub.TRANSACTION_getAdnRecordsCapacityForSubscriber, _data, _reply, 0);
_reply.readException();
_result = _reply.createIntArray();
}
finally {
...
static final int TRANSACTION_updateAdnRecordsWithContentValuesInEfBySearchUsingSubId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_updateAdnRecordsInEfByIndex = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_updateAdnRecordsInEfByIndexForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_getAdnRecordsSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getAdnRecordsSizeForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getAdnRecordsCapacity = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getAdnRecordsCapacityForSubscriber = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
}
/**
     * Loads the AdnRecords in efid and returns them as a
     * List of AdnRecords
...
/**
     ...
     * @return true for success
     */
public boolean updateAdnRecordsWithContentValuesInEfBySearchUsingSubId(int subId, int efid, android.content.ContentValues values, java.lang.String pin2) throws android.os.RemoteException;
/**
     * Update an ADN-like EF record by record index
     *
     * This is useful for iteration the whole ADN file, such as write the whole
