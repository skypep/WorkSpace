...
public final class KeepaliveRequest {
    public int type;
    public final java.util.ArrayList<Byte> sourceAddress = new java.util.ArrayList<Byte>();
    public int sourcePort;
    public final java.util.ArrayList<Byte> destinationAddress = new java.util.ArrayList<Byte>();
    ...
    public static final java.util.ArrayList<KeepaliveRequest> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_1.KeepaliveRequest _hidl_vec_element = new android.hardware.radio.V1_1.KeepaliveRequest();
    ...
    public final void readEmbeddedFromParcel(
        ...
        type = _hidl_blob.getInt32(_hidl_offset + 0);
        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                sourceAddress.add(_hidl_vec_element);
            }
        }
        sourcePort = _hidl_blob.getInt32(_hidl_offset + 24);
        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                byte _hidl_vec_element;
                _hidl_vec_element = childBlob.getInt8(_hidl_index_0 * 1);
                destinationAddress.add(_hidl_vec_element);
            }
        }
