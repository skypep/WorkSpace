...
public final class NetworkScanResult {
    public int status;
    public int error;
    public final java.util.ArrayList<android.hardware.radio.V1_0.CellInfo> networkInfos = new java.util.ArrayList<android.hardware.radio.V1_0.CellInfo>();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_1.NetworkScanResult.class) {
            return false;
        }
        android.hardware.radio.V1_1.NetworkScanResult other = (android.hardware.radio.V1_1.NetworkScanResult)otherObject;
    ...
    public static final java.util.ArrayList<NetworkScanResult> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_1.NetworkScanResult _hidl_vec_element = new android.hardware.radio.V1_1.NetworkScanResult();
    ...
    public final void readEmbeddedFromParcel(
        ...
        error = _hidl_blob.getInt32(_hidl_offset + 4);
        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                networkInfos.add(_hidl_vec_element);
            }
        }
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 4, error);
        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                networkInfos.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 104);
            }
