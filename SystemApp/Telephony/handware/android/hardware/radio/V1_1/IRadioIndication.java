...
public interface IRadioIndication extends android.hardware.radio.V1_0.IRadioIndication {
    ...
    public static IRadioIndication getService(String serviceName) throws android.os.RemoteException {
        return IRadioIndication.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.1::IRadioIndication",serviceName));
    }

    public static IRadioIndication getService() throws android.os.RemoteException {
        return IRadioIndication.asInterface(android.os.HwBinder.getService("android.hardware.radio@1.1::IRadioIndication","default"));
    }

    void carrierInfoForImsiEncryption(int info)
        throws android.os.RemoteException;
    void networkScanResult(int type, NetworkScanResult result)
        throws android.os.RemoteException;
    void keepaliveStatus(int type, KeepaliveStatus status)
        throws android.os.RemoteException;
    ...
    public static final class Proxy implements IRadioIndication {
        ...
        public void carrierInfoForImsiEncryption(int info)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(46 /* carrierInfoForImsiEncryption */, _hidl_request, _hidl_reply, android.os.IHwBinder.FLAG_ONEWAY);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void networkScanResult(int type, NetworkScanResult result)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(47 /* networkScanResult */, _hidl_request, _hidl_reply, android.os.IHwBinder.FLAG_ONEWAY);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void keepaliveStatus(int type, KeepaliveStatus status)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(48 /* keepaliveStatus */, _hidl_request, _hidl_reply, android.os.IHwBinder.FLAG_ONEWAY);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
