...
public final class ImsiEncryptionInfo {
    ...
    public final java.util.ArrayList<Byte> carrierKey = new java.util.ArrayList<Byte>();
    ...
    public static final java.util.ArrayList<ImsiEncryptionInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_1.ImsiEncryptionInfo _hidl_vec_element = new android.hardware.radio.V1_1.ImsiEncryptionInfo();
    ...
    public final void readEmbeddedFromParcel(
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                carrierKey.add(_hidl_vec_element);
            }
        }
        keyIdentifier = _hidl_blob.getString(_hidl_offset + 48);

        parcel.readEmbeddedBuffer(
                keyIdentifier.getBytes().length + 1,
                _hidl_blob.handle(),
