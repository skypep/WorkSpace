...
public final class CfData {
    public final java.util.ArrayList<android.hardware.radio.V1_0.CallForwardInfo> cfInfo = new java.util.ArrayList<android.hardware.radio.V1_0.CallForwardInfo>();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_0.CfData.class) {
            return false;
        }
        android.hardware.radio.V1_0.CfData other = (android.hardware.radio.V1_0.CfData)otherObject;
        if (!android.os.HidlSupport.deepEquals(this.cfInfo, other.cfInfo)) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                android.os.HidlSupport.deepHashCode(this.cfInfo));
    }
    ...
    public static final java.util.ArrayList<CfData> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<CfData> _hidl_vec = new java.util.ArrayList();
    ...
    public final void readEmbeddedFromParcel(
            android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
        {
            ...
            cfInfo.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CallForwardInfo _hidl_vec_element = new android.hardware.radio.V1_0.CallForwardInfo();
                _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 40);
                cfInfo.add(_hidl_vec_element);
            }
        }
    }
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<CfData> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        {
            int _hidl_vec_size = cfInfo.size();
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                cfInfo.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 40);
            }
