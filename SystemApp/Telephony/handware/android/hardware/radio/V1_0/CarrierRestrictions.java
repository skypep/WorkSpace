...
public final class CarrierRestrictions {
    public final java.util.ArrayList<android.hardware.radio.V1_0.Carrier> allowedCarriers = new java.util.ArrayList<android.hardware.radio.V1_0.Carrier>();
    public final java.util.ArrayList<android.hardware.radio.V1_0.Carrier> excludedCarriers = new java.util.ArrayList<android.hardware.radio.V1_0.Carrier>();
    ...
    public static final java.util.ArrayList<CarrierRestrictions> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CarrierRestrictions _hidl_vec_element = new android.hardware.radio.V1_0.CarrierRestrictions();
    ...
    public final void readEmbeddedFromParcel(
            android.os.HwParcel parcel, android.os.HwBlob _hidl_blob, long _hidl_offset) {
        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                allowedCarriers.add(_hidl_vec_element);
            }
        }
        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.Carrier _hidl_vec_element = new android.hardware.radio.V1_0.Carrier();
                _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 56);
                excludedCarriers.add(_hidl_vec_element);
            }
        }
    }
