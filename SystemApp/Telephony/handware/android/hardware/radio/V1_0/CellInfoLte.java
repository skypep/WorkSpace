...
public final class CellInfoLte {
    public final android.hardware.radio.V1_0.CellIdentityLte cellIdentityLte = new android.hardware.radio.V1_0.CellIdentityLte();
    public final android.hardware.radio.V1_0.LteSignalStrength signalStrengthLte = new android.hardware.radio.V1_0.LteSignalStrength();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_0.CellInfoLte.class) {
            return false;
        }
        android.hardware.radio.V1_0.CellInfoLte other = (android.hardware.radio.V1_0.CellInfoLte)otherObject;
    ...
    public final void readEmbeddedFromParcel(
        ...
        cellIdentityLte.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        signalStrengthLte.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 48);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        signalStrengthLte.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 48);
    }
};
