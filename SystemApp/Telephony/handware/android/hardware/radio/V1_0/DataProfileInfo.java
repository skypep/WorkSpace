...
public final class DataProfileInfo {
    ...
    public static final java.util.ArrayList<DataProfileInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.DataProfileInfo _hidl_vec_element = new android.hardware.radio.V1_0.DataProfileInfo();
    ...
    public final void readEmbeddedFromParcel(
        ...
        parcel.readEmbeddedBuffer(
                roamingProtocol.getBytes().length + 1,
                _hidl_blob.handle(),
        ...
        parcel.readEmbeddedBuffer(
                mvnoMatchData.getBytes().length + 1,
                _hidl_blob.handle(),
