...
public final class CdmaSmsSubaddress {
    ...
    public boolean odd;
    public final java.util.ArrayList<Byte> digits = new java.util.ArrayList<Byte>();
    ...
    public static final java.util.ArrayList<CdmaSmsSubaddress> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CdmaSmsSubaddress _hidl_vec_element = new android.hardware.radio.V1_0.CdmaSmsSubaddress();
