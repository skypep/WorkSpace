...
public final class SsInfoData {
    public final java.util.ArrayList<Integer> ssInfo = new java.util.ArrayList<Integer>();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_0.SsInfoData.class) {
            return false;
        }
        android.hardware.radio.V1_0.SsInfoData other = (android.hardware.radio.V1_0.SsInfoData)otherObject;
    ...
    public static final java.util.ArrayList<SsInfoData> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<SsInfoData> _hidl_vec = new java.util.ArrayList();
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<SsInfoData> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
            android.os.HwBlob _hidl_blob, long _hidl_offset) {
        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                childBlob.putInt32(_hidl_index_0 * 4, ssInfo.get(_hidl_index_0));
            }
