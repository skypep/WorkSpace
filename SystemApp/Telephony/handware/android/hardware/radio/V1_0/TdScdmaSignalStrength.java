...
public final class TdScdmaSignalStrength {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_0.TdScdmaSignalStrength.class) {
            return false;
        }
        android.hardware.radio.V1_0.TdScdmaSignalStrength other = (android.hardware.radio.V1_0.TdScdmaSignalStrength)otherObject;
    ...
    public static final java.util.ArrayList<TdScdmaSignalStrength> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.TdScdmaSignalStrength _hidl_vec_element = new android.hardware.radio.V1_0.TdScdmaSignalStrength();
    ...
    public final void readEmbeddedFromParcel(
        ...
        rscp = _hidl_blob.getInt32(_hidl_offset + 0);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 0, rscp);
    }
};
