...
public final class SignalStrength {
    public final android.hardware.radio.V1_0.GsmSignalStrength gw = new android.hardware.radio.V1_0.GsmSignalStrength();
    public final android.hardware.radio.V1_0.CdmaSignalStrength cdma = new android.hardware.radio.V1_0.CdmaSignalStrength();
    public final android.hardware.radio.V1_0.EvdoSignalStrength evdo = new android.hardware.radio.V1_0.EvdoSignalStrength();
    public final android.hardware.radio.V1_0.LteSignalStrength lte = new android.hardware.radio.V1_0.LteSignalStrength();
    public final android.hardware.radio.V1_0.TdScdmaSignalStrength tdScdma = new android.hardware.radio.V1_0.TdScdmaSignalStrength();
    ...
    public static final java.util.ArrayList<SignalStrength> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.SignalStrength _hidl_vec_element = new android.hardware.radio.V1_0.SignalStrength();
    ...
    public final void readEmbeddedFromParcel(
        ...
        gw.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        cdma.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 12);
        evdo.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 20);
        lte.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 32);
        tdScdma.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 56);
    }
