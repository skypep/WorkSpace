...
public final class CdmaSmsMessage {
    ...
    public final android.hardware.radio.V1_0.CdmaSmsAddress address = new android.hardware.radio.V1_0.CdmaSmsAddress();
    public final android.hardware.radio.V1_0.CdmaSmsSubaddress subAddress = new android.hardware.radio.V1_0.CdmaSmsSubaddress();
    public final java.util.ArrayList<Byte> bearerData = new java.util.ArrayList<Byte>();
    ...
    public final void readEmbeddedFromParcel(
        ...
        address.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 16);
        subAddress.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 48);
        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                bearerData.add(_hidl_vec_element);
            }
        }
    }
