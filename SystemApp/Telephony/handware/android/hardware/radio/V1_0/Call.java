...
public final class Call {
    ...
    public final java.util.ArrayList<android.hardware.radio.V1_0.UusInfo> uusInfo = new java.util.ArrayList<android.hardware.radio.V1_0.UusInfo>();
    ...
    public static final java.util.ArrayList<Call> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.Call _hidl_vec_element = new android.hardware.radio.V1_0.Call();
    ...
    public final void readEmbeddedFromParcel(
        ...
        namePresentation = _hidl_blob.getInt32(_hidl_offset + 64);
        {
            ...
            uusInfo.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.UusInfo _hidl_vec_element = new android.hardware.radio.V1_0.UusInfo();
                _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 24);
                uusInfo.add(_hidl_vec_element);
            }
        }
    }
