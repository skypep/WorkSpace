...
public final class CdmaSmsWriteArgs {
    public int status;
    public final android.hardware.radio.V1_0.CdmaSmsMessage message = new android.hardware.radio.V1_0.CdmaSmsMessage();
    ...
    public static final java.util.ArrayList<CdmaSmsWriteArgs> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CdmaSmsWriteArgs _hidl_vec_element = new android.hardware.radio.V1_0.CdmaSmsWriteArgs();
    ...
    public final void readEmbeddedFromParcel(
        ...
        message.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 8);
    }
