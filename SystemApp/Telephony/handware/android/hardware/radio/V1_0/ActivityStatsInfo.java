...
public final class ActivityStatsInfo {
    ...
    public final int[/* RadioConst:NUM_TX_POWER_LEVELS */] txmModetimeMs = new int[5 /* RadioConst:NUM_TX_POWER_LEVELS */];
    ...
    public static final java.util.ArrayList<ActivityStatsInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.ActivityStatsInfo _hidl_vec_element = new android.hardware.radio.V1_0.ActivityStatsInfo();
    ...
    public final void readEmbeddedFromParcel(
        ...
        idleModeTimeMs = _hidl_blob.getInt32(_hidl_offset + 4);
        {
            ...
            for (int _hidl_index_0_0 = 0; _hidl_index_0_0 < 5; ++_hidl_index_0_0) {
                txmModetimeMs[_hidl_index_0_0] = _hidl_blob.getInt32(_hidl_array_offset_0);
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 4, idleModeTimeMs);
        {
            long _hidl_array_offset_0 = _hidl_offset + 8;
            for (int _hidl_index_0_0 = 0; _hidl_index_0_0 < 5; ++_hidl_index_0_0) {
                _hidl_blob.putInt32(_hidl_array_offset_0, txmModetimeMs[_hidl_index_0_0]);
                _hidl_array_offset_0 += 4;
            }
        }
