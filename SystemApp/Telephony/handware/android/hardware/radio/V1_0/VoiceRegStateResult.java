...
public final class VoiceRegStateResult {
    ...
    public static final java.util.ArrayList<VoiceRegStateResult> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.VoiceRegStateResult _hidl_vec_element = new android.hardware.radio.V1_0.VoiceRegStateResult();
    ...
    public final void readEmbeddedFromParcel(
        ...
        cellIdentity.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 32);
    }
