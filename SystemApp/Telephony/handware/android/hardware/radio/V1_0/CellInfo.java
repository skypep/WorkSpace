...
public final class CellInfo {
    ...
    public final java.util.ArrayList<android.hardware.radio.V1_0.CellInfoGsm> gsm = new java.util.ArrayList<android.hardware.radio.V1_0.CellInfoGsm>();
    public final java.util.ArrayList<android.hardware.radio.V1_0.CellInfoCdma> cdma = new java.util.ArrayList<android.hardware.radio.V1_0.CellInfoCdma>();
    public final java.util.ArrayList<android.hardware.radio.V1_0.CellInfoLte> lte = new java.util.ArrayList<android.hardware.radio.V1_0.CellInfoLte>();
    public final java.util.ArrayList<android.hardware.radio.V1_0.CellInfoWcdma> wcdma = new java.util.ArrayList<android.hardware.radio.V1_0.CellInfoWcdma>();
    public final java.util.ArrayList<android.hardware.radio.V1_0.CellInfoTdscdma> tdscdma = new java.util.ArrayList<android.hardware.radio.V1_0.CellInfoTdscdma>();
    ...
    public static final java.util.ArrayList<CellInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CellInfo _hidl_vec_element = new android.hardware.radio.V1_0.CellInfo();
    ...
    public final void readEmbeddedFromParcel(
        ...
        timeStamp = _hidl_blob.getInt64(_hidl_offset + 16);
        {
            ...
            gsm.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CellInfoGsm _hidl_vec_element = new android.hardware.radio.V1_0.CellInfoGsm();
                _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 64);
                gsm.add(_hidl_vec_element);
            }
        }
        {
            ...
            cdma.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CellInfoCdma _hidl_vec_element = new android.hardware.radio.V1_0.CellInfoCdma();
                _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 40);
                cdma.add(_hidl_vec_element);
            }
        }
        {
            ...
            lte.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CellInfoLte _hidl_vec_element = new android.hardware.radio.V1_0.CellInfoLte();
                _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 72);
                lte.add(_hidl_vec_element);
            }
        }
        {
        ...
        }
        {
            ...
            tdscdma.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CellInfoTdscdma _hidl_vec_element = new android.hardware.radio.V1_0.CellInfoTdscdma();
                _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 56);
                tdscdma.add(_hidl_vec_element);
            }
        }
    }
