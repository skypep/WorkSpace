...
public final class CellInfoTdscdma {
    public final android.hardware.radio.V1_0.CellIdentityTdscdma cellIdentityTdscdma = new android.hardware.radio.V1_0.CellIdentityTdscdma();
    public final android.hardware.radio.V1_0.TdScdmaSignalStrength signalStrengthTdscdma = new android.hardware.radio.V1_0.TdScdmaSignalStrength();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_0.CellInfoTdscdma.class) {
            return false;
        }
        android.hardware.radio.V1_0.CellInfoTdscdma other = (android.hardware.radio.V1_0.CellInfoTdscdma)otherObject;
    ...
    public final void readEmbeddedFromParcel(
        ...
        cellIdentityTdscdma.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        signalStrengthTdscdma.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 48);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        signalStrengthTdscdma.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 48);
    }
};
