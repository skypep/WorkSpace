...
public final class DataRegStateResult {
    ...
    public final android.hardware.radio.V1_0.CellIdentity cellIdentity = new android.hardware.radio.V1_0.CellIdentity();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_0.DataRegStateResult.class) {
            return false;
        }
        android.hardware.radio.V1_0.DataRegStateResult other = (android.hardware.radio.V1_0.DataRegStateResult)otherObject;
    ...
    public static final java.util.ArrayList<DataRegStateResult> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.DataRegStateResult _hidl_vec_element = new android.hardware.radio.V1_0.DataRegStateResult();
    ...
    public final void readEmbeddedFromParcel(
        ...
        cellIdentity.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 16);
    }
