...
public final class ImsSmsMessage {
    ...
    public final java.util.ArrayList<android.hardware.radio.V1_0.CdmaSmsMessage> cdmaMessage = new java.util.ArrayList<android.hardware.radio.V1_0.CdmaSmsMessage>();
    public final java.util.ArrayList<android.hardware.radio.V1_0.GsmSmsMessage> gsmMessage = new java.util.ArrayList<android.hardware.radio.V1_0.GsmSmsMessage>();
    ...
    public static final java.util.ArrayList<ImsSmsMessage> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.ImsSmsMessage _hidl_vec_element = new android.hardware.radio.V1_0.ImsSmsMessage();
    ...
    public final void readEmbeddedFromParcel(
        ...
        messageRef = _hidl_blob.getInt32(_hidl_offset + 8);
        {
            ...
            cdmaMessage.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CdmaSmsMessage _hidl_vec_element = new android.hardware.radio.V1_0.CdmaSmsMessage();
                _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 88);
                cdmaMessage.add(_hidl_vec_element);
            }
        }
        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                ...
                gsmMessage.add(_hidl_vec_element);
            }
        }
    }
