...
public final class CellInfoCdma {
    public final android.hardware.radio.V1_0.CellIdentityCdma cellIdentityCdma = new android.hardware.radio.V1_0.CellIdentityCdma();
    public final android.hardware.radio.V1_0.CdmaSignalStrength signalStrengthCdma = new android.hardware.radio.V1_0.CdmaSignalStrength();
    public final android.hardware.radio.V1_0.EvdoSignalStrength signalStrengthEvdo = new android.hardware.radio.V1_0.EvdoSignalStrength();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_0.CellInfoCdma.class) {
            return false;
        }
        android.hardware.radio.V1_0.CellInfoCdma other = (android.hardware.radio.V1_0.CellInfoCdma)otherObject;
    ...
    public final void readEmbeddedFromParcel(
        ...
        cellIdentityCdma.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 0);
        signalStrengthCdma.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 20);
        signalStrengthEvdo.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 28);
    }
    ...
    public final void writeEmbeddedToBlob(
        ...
        signalStrengthCdma.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 20);
        signalStrengthEvdo.writeEmbeddedToBlob(_hidl_blob, _hidl_offset + 28);
    }
};
