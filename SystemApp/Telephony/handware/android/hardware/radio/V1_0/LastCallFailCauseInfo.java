    ...
    public static final java.util.ArrayList<LastCallFailCauseInfo> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.LastCallFailCauseInfo _hidl_vec_element = new android.hardware.radio.V1_0.LastCallFailCauseInfo();
