...
public final class HardwareConfig {
    ...
    public int state;
    public final java.util.ArrayList<android.hardware.radio.V1_0.HardwareConfigModem> modem = new java.util.ArrayList<android.hardware.radio.V1_0.HardwareConfigModem>();
    public final java.util.ArrayList<android.hardware.radio.V1_0.HardwareConfigSim> sim = new java.util.ArrayList<android.hardware.radio.V1_0.HardwareConfigSim>();
    ...
    public static final java.util.ArrayList<HardwareConfig> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.HardwareConfig _hidl_vec_element = new android.hardware.radio.V1_0.HardwareConfig();
    ...
    public final void readEmbeddedFromParcel(
        ...
        state = _hidl_blob.getInt32(_hidl_offset + 24);
        {
            ...
            modem.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.HardwareConfigModem _hidl_vec_element = new android.hardware.radio.V1_0.HardwareConfigModem();
                _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 20);
                modem.add(_hidl_vec_element);
            }
        }
        {
