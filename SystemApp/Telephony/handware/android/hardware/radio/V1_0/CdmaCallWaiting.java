...
public final class CdmaCallWaiting {
    ...
    public final android.hardware.radio.V1_0.CdmaSignalInfoRecord signalInfoRecord = new android.hardware.radio.V1_0.CdmaSignalInfoRecord();
    ...
    public static final java.util.ArrayList<CdmaCallWaiting> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CdmaCallWaiting _hidl_vec_element = new android.hardware.radio.V1_0.CdmaCallWaiting();
    ...
    public final void readEmbeddedFromParcel(
        ...
        signalInfoRecord.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 40);
