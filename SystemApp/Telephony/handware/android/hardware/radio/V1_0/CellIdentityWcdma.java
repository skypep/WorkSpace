...
public final class CellIdentityWcdma {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject.getClass() != android.hardware.radio.V1_0.CellIdentityWcdma.class) {
            return false;
        }
        android.hardware.radio.V1_0.CellIdentityWcdma other = (android.hardware.radio.V1_0.CellIdentityWcdma)otherObject;
    ...
    public final int hashCode() {
        return java.util.Objects.hash(
                ...
                android.os.HidlSupport.deepHashCode(this.psc), 
    ...
    public static final java.util.ArrayList<CellIdentityWcdma> readVectorFromParcel(android.os.HwParcel parcel) {
        java.util.ArrayList<CellIdentityWcdma> _hidl_vec = new java.util.ArrayList();
    ...
    public final void readEmbeddedFromParcel(
        ...
        psc = _hidl_blob.getInt32(_hidl_offset + 40);
        uarfcn = _hidl_blob.getInt32(_hidl_offset + 44);
    }
    ...
    public static final void writeVectorToParcel(
            android.os.HwParcel parcel, java.util.ArrayList<CellIdentityWcdma> _hidl_vec) {
    ...
    public final void writeEmbeddedToBlob(
        ...
        _hidl_blob.putInt32(_hidl_offset + 40, psc);
        _hidl_blob.putInt32(_hidl_offset + 44, uarfcn);
    }
};
