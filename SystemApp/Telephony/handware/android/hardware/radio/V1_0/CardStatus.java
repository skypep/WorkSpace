...
public final class CardStatus {
    ...
    public final java.util.ArrayList<android.hardware.radio.V1_0.AppStatus> applications = new java.util.ArrayList<android.hardware.radio.V1_0.AppStatus>();
    ...
    public static final java.util.ArrayList<CardStatus> readVectorFromParcel(android.os.HwParcel parcel) {
...

        {
            ...
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.CardStatus _hidl_vec_element = new android.hardware.radio.V1_0.CardStatus();
    ...
    public final void readEmbeddedFromParcel(
        ...
        imsSubscriptionAppIndex = _hidl_blob.getInt32(_hidl_offset + 16);
        {
            ...
            applications.clear();
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; ++_hidl_index_0) {
                final android.hardware.radio.V1_0.AppStatus _hidl_vec_element = new android.hardware.radio.V1_0.AppStatus();
                _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 64);
                applications.add(_hidl_vec_element);
            }
        }
    }
