...
public class ListsFragment extends Fragment implements OnPageChangeListener, Listener {
  ...
  public View onCreateView(
    ...
    tabIcons[TAB_INDEX_HISTORY] = R.drawable.calllog_selector;
    tabIcons[TAB_INDEX_ALL_CONTACTS] = R.drawable.contact_selector;
    ...
    mViewPagerTabs.configureTabText(tabTitles);
  ...
  public boolean exitEditModle() {
    showMultiSelectRemoveView(false);
    return ((CallLogFragment) getmCurrentPage()).exitEditModle();
  }
