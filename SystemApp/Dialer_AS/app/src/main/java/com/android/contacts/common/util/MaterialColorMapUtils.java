...
public class MaterialColorMapUtils {
  ...
  public MaterialColorMapUtils(Resources resources) {
    sPrimaryColors =
        resources.obtainTypedArray(com.android.dialer.R.array.letter_tile_colors);// fixed by liujia com.android.contacts.common.R
    sSecondaryColors =
        resources.obtainTypedArray(com.android.dialer.R.array.letter_tile_colors_dark);// fixed by liujia com.android.contacts.common.R
  }
