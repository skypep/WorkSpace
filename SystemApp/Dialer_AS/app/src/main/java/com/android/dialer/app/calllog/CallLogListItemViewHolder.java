...
//  public final TextView dayGroupHeader; liujia delete
  ...
  public final TextView toroCallDateText;
...
//  public ImageView checkBoxView; liujia delete
  ...
  public PhoneCallDetails details;

  private boolean isSelected = false;
  private boolean isEditMode = false;
  private int position = -1;
  private CallLogAdapter.OnRadioChangeListener onRadioChangeListener;

  private CallLogListItemViewHolder(
      Context context,
      CallLogAdapter.OnRadioChangeListener onRadioChangeListener,
      ...
      ImageView toroActionButtonView,
      ImageView toroCallTypeIcon,
      ImageView toroEditRadioIcon,
      TextView toroCallDateText) {
    super(rootView);
    ...
    this.toroCallTypeIcon = toroCallTypeIcon;
    this.toroEditRadioIcon = toroEditRadioIcon;
    this.toroCallDateText = toroCallDateText;
    ...
    this.toroActionButtonView = toroActionButtonView;
    ...
    this.toroActionButtonView.setOnClickListener(this);

    this.primaryActionView.setOnClickListener(this); // liujia fixed
    if (mVoicemailPlaybackPresenter != null
      ...
      this.primaryActionView.setOnLongClickListener(longPressListener);
    } else {
      this.primaryActionView.setOnCreateContextMenuListener(this);
    }
  }

  private void updateRadioSelecte(boolean isSelected) {
    this.isSelected = isSelected;
    if(isSelected) {
      toroEditRadioIcon.setImageResource(R.drawable.toro_radio_selected);
    } else {
      toroEditRadioIcon.setImageResource(R.drawable.toro_radio_un_selected);
    }
  }

  public void initEditMode(boolean isSelected,int position) {
    this.isEditMode = true;
    this.position = position;
    updateRadioSelecte(isSelected);
  }
  ...
  public static CallLogListItemViewHolder create(
    ...
    return new CallLogListItemViewHolder(
        ...
        (ImageView) view.findViewById(R.id.primary_action_button),
            ...
            (ImageView) view.findViewById(R.id.toro_call_edit_radio),
            (TextView) view.findViewById(R.id.toro_call_date_text));
  }
...
//    this.toroActionButtonView.setTag(this);
...
//      if (!isExpanded) {
//        toroActionButtonView.setImageResource(R.drawable.quantum_ic_play_arrow_white_24);
//        toroActionButtonView.setContentDescription(
//            TextUtils.expandTemplate(
//                mContext.getString(R.string.description_voicemail_action), validNameOrNumber));
//        toroActionButtonView.setVisibility(View.VISIBLE);
//      } else {
//        toroActionButtonView.setVisibility(View.GONE);
//      }
//    } else {
...
//          toroActionButtonView.setTag(IntentProvider.getLightbringerIntentProvider(number));
//          toroActionButtonView.setContentDescription(
//              TextUtils.expandTemplate(
//                  mContext.getString(R.string.description_video_call_action), validNameOrNumber));
//          toroActionButtonView.setImageResource(R.drawable.quantum_ic_videocam_vd_theme_24);
//          toroActionButtonView.setVisibility(View.VISIBLE);
//          return;
//        }
//
...
//          toroActionButtonView.setTag(IntentProvider.getReturnVoicemailCallIntentProvider());
//        } else {
//          toroActionButtonView.setTag(
...
//        toroActionButtonView.setImageResource(R.drawable.quantum_ic_call_vd_theme_24);
//        toroActionButtonView.setVisibility(View.VISIBLE);
//      } else {
//        toroActionButtonView.setTag(null);
//        toroActionButtonView.setVisibility(View.GONE);
//      }
//    }
  }
...
//            getContactType());
  ...
  public void onClick(View view) {
    if (view.getId() == R.id.primary_action_view) {
      if(isEditMode) {
        updateRadioSelecte(!isSelected);
        onRadioChangeListener.onChange(isSelected,position);
        return;
      } else {
        CallLogAsyncTaskUtil.markCallAsRead(mContext, callIds);
        final IntentProvider intentProvider = IntentProvider.getReturnCallIntentProvider(number + postDialDigits);
