...
//    }
    ...
    int nameColor = details.callTypes[0] == CallLog.Calls.MISSED_TYPE ? R.color.toro_calllog_miss_call_color : R.color.call_log_detail_color;
    views.nameView.setTextColor(mContext.getResources().getColor(nameColor));
    // Bold if not read
