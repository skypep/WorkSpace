  ...
  public void bind(Cursor cursor, String query) {
    ...
    String secondaryInfo =
        TextUtils.isEmpty(label)
            ? number
            : context.getString(
                com.android.dialer.R.string.call_subject_type_and_number, label, number);// fixed by liujia com.android.contacts.common.R
    ...
    switch (currentAction) {
      ...
      case CallToAction.SHARE_AND_CALL:
        ...
        callToActionView.setImageDrawable(
            context.getDrawable(com.android.dialer.R.drawable.ic_phone_attach));// fixed by liujia com.android.contacts.common.R
