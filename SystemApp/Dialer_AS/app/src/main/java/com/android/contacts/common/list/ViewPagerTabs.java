...
import com.android.dialer.R;// fixed by liujia back com.android.dialer.searchfragment.common.R;
...
//      tabView.setSelected(true);
        setTabSelected(tabView, true);
    } else if(position == mPrevSelected) {
        setTabSelected(tabView, true);
    }
  }
   ...
   * liujia add
   */
  private void setTabSelected(View tabView,boolean isSelected) {
    if(isSelected) {
      tabView.setBackgroundColor(getResources().getColor(R.color.toro_tab_selected_backgroud));
    }else {
      tabView.setBackgroundColor(getResources().getColor(R.color.toro_tab_normal_backgroud));
    }
