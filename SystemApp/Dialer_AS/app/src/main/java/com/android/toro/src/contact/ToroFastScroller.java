...
/** Widget to add fast scrolling to {@link ToroContactsPickActivity}. */
public class ToroFastScroller extends RelativeLayout {
  ...
  public ToroFastScroller(Context context, AttributeSet attrs) {
    super(context, attrs);
    touchTargetWidth =
        context.getResources().getDimensionPixelSize(com.android.dialer.contactsfragment.R.dimen.fast_scroller_touch_target_width);
  }

  @Override
  protected void onFinishInflate() {
    super.onFinishInflate();
    container = findViewById(com.android.dialer.contactsfragment.R.id.fast_scroller_container);
    scrollBar = findViewById(com.android.dialer.contactsfragment.R.id.fast_scroller_scroll_bar);
  }

  void setup(ToroContactsAdapter adapter, LinearLayoutManager layoutManager) {
