...
public class DialtactsPagerAdapter extends FragmentPagerAdapter {
  ...
  @IntDef({TAB_INDEX_HISTORY, TAB_INDEX_ALL_CONTACTS, TAB_INDEX_VOICEMAIL})
...
//  public static final int TAB_INDEX_SPEED_DIAL = 0;
  ...
  public DialtactsPagerAdapter(
    ...
    fragments.addAll(Collections.nCopies(TAB_INDEX_VOICEMAIL, null)); // fixed by liujia
  }
  ...
  @Override
  public int getCount() {
    return TAB_INDEX_VOICEMAIL; // fixed by liujia
  }
