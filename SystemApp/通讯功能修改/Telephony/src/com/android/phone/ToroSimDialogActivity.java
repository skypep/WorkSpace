...
public class ToroSimDialogActivity extends Activity {
    private static String TAG = "ToroSimDialogActivity";
    ...
    private void displayPreferredDialog(final int slotId) {
        ...
        if (sir != null) {
            ...
            alertDialogBuilder.setTitle(R.string.toro_sim_preferred_title);
            alertDialogBuilder.setMessage(res.getString(
                    R.string.toro_sim_preferred_message, sir.getDisplayName()));

            alertDialogBuilder.setPositiveButton(R.string.toro_yes, new
            ...
            alertDialogBuilder.setNegativeButton(R.string.toro_no, new
                    DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog,int id) {
                    finish();
    ...
    public Dialog createDialog(final Context context, final int id,
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int value) {
                        ...
                        if (id != DATA_PICK || !ddsalertDisplayed) {
                            ...
                            finish();
                            if (hasDdsChanged) {
                                Toast.makeText(ToroSimDialogActivity.this, R.string.toro_data_switch_started,
        ...
        if (id == CALLS_PICK) {
            ...
            list.add(getResources().getString(R.string.toro_sim_calls_ask_first_prefs_title));
        ...
        ListAdapter adapter = new SelectAccountListAdapter(
                ...
                builder.getContext(),
                R.layout.toro_select_account_list_item,
                arr, id);

        switch (id) {
            case DATA_PICK:
                builder.setTitle(R.string.toro_select_sim_for_data);
                break;
            case CALLS_PICK:
                builder.setTitle(R.string.toro_select_sim_for_calls);
                break;
            case SMS_PICK:
                builder.setTitle(R.string.toro_sim_card_select_title);
                break;
            default:
                throw new IllegalArgumentException("Invalid dialog type "
                        + id + " in SIM dialog.");
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (sir == null) {
                ...
                holder.icon.setImageDrawable(getResources()
                        .getDrawable(R.drawable.toro_ic_always_ask));
        ...
        if (isDdsSwitchAlertDialogSupported(context, defaultDataSubId) &&
            ...
            alertDlg.setButton(yes, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    subscriptionManager.setDefaultDataSubId(subId);
                    setUserPrefDataSubIdInDb(subId);
                    Toast.makeText(context, R.string.toro_data_switch_started, Toast.LENGTH_LONG)
                            .show();
                    finish();
                }
            });
