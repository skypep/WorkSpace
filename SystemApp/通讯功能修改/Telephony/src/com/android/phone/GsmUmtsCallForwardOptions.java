...
//        }
        ...
        actionBar.setBackgroundDrawable(getDrawable(R.drawable.bg_settings_header));

        RelativeLayout actionLayout = (RelativeLayout) actionBar.getCustomView().findViewById(R.id.action_layout);
        ((TextView)actionLayout.findViewById(R.id.tv_title)).setText(R.string.call_forwarding_settings);
        actionLayout.findViewById(R.id.ll_back).setOnClickListener(new View.OnClickListener() {
            @Override
